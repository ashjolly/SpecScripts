...
directory_1 <-"/Users/ashlee/Documents/WaterAct Paper/splitfiles_1" #where all of the split PDFs are located
directory_2 <-"/Users/ashlee/Documents/WaterAct Paper/splitfiles_2" #where all of the split PDFs are located
directory_3 <-"/Users/ashlee/Documents/WaterAct Paper/splitfiles_3" #where all of the split PDFs are located
