...
# @import ggplot2
# @import scales
# From #' # From http://www.headwateranalytics.com/blog/flood-frequency-analysis-in-r
...
frequencyPlot <- function(series, ci) {
  ...
  ggplot(bwpeaks) + 
    ...
    theme_bw() + 
    scale_y_continuous(trans="log10", breaks=ybreaks, name="Discharge (L/s)", limits = c(2E-2, 2E3)) +
